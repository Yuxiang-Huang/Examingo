...
const MultipleChoice = () => {
  ...
  return <div>
    ...
    <MultipleChoiceButton optionText="Choice 1 oifejaiofjwefj aewjafi jweioj fwjef jewoij  foeijwafoijewfjwej fjw jeiowjfa" isCorrect={false} isRevealed={isRevealed} setIsRevealed={setIsRevealed}/>
    <MultipleChoiceButton optionText="Paris" isCorrect={true} isRevealed={isRevealed} setIsRevealed={setIsRevealed}/>
